...
import CategoryGridList from './../../component/carts/categoryGridView';
import CategoryList from './../../component/carts/categoryList';

const {height, width} = Dimensions.get('window');

const CategoryGridView = ({navigation}) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(CategoryGridView);
